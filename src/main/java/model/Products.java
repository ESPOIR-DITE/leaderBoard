...
public class Products extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6267145142211876014L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Products\",\"namespace\":\"model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public Products(java.lang.Long id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static model.Products.Builder newBuilder() {
    return new model.Products.Builder();
  }
   ...
   * @return A new Products RecordBuilder
   */
  public static model.Products.Builder newBuilder(model.Products.Builder other) {
    if (other == null) {
      return new model.Products.Builder();
    } else {
      return new model.Products.Builder(other);
    }
  }
   ...
   * @return A new Products RecordBuilder
   */
  public static model.Products.Builder newBuilder(model.Products other) {
    if (other == null) {
      return new model.Products.Builder();
    } else {
      return new model.Products.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Products>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.Products.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.Products other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Products.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Products.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Products.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Products.Builder clearName() {
      name = null;
